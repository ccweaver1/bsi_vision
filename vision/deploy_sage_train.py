...
if init_ckpt:
    ckpt_dir = init_ckpt
    init_ckpt = "s3://sagemaker-us-east-1-359098845427/bsi-training-vgg16-pool-2018-05-17-17-46-59/checkpoints/"
    tf_estimator = TensorFlow(entry_point='sage_train.py',
...
tf_estimator.fit(str(train_path), job_name=job_name)
