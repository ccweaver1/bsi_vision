...
from ..retinanet_utils.anchors import make_shapes_callback, anchor_targets_bbox
from ..retinanet_utils.keras_version import check_keras_version
from ..retinanet_utils.model import freeze as freeze_model
from ..retinanet_utils.transform import random_transform_generator
...
def create_callbacks(model, training_model, prediction_model, validation_generator, args):
    ...
    if args.snapshots:
        ...
        checkpoint = keras.callbacks.ModelCheckpoint(
            os.path.join(
                args.snapshot_path,
                '{backbone}_{dataset_type}_{{epoch + args.starting_epoch:02d}}.h5'.format(backbone=args.backbone, dataset_type=args.dataset_type)
            ),
            verbose=1,
